...
at the following locations:<br>
        ...
        <img src="http://www.evolt.org/evolt/images/spacer.gif" height="5" width="170" border="0" alt=""><br>
...
<?
	...
	if ($browserFileOK == "yes")
	{
		...
		if ($downloadFile = fopen($dataFile,"r"))
		{
			...
			while(!feof($downloadFile))
			{
				...
				{
					print "&raquo; <code>[$downloadField[3]/$downloadField[6]]</code> <a href=\"$downloadPath\">$downloadField[1]</a><br>\n";
				}
			}
	...
	//show the above text and get the hell outta here
        ...
        if ( time () < filectime(substr($filecheck,1,strlen($filecheck))) + 172800 ) {
                ?><hr noshade size="1">
<em>Please note that this file was added to the<br />
Archive less than 48 hours ago, and may<br />
not be available from our mirrors.<?
        }
